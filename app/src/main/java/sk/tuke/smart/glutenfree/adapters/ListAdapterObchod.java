...
public class ListAdapterObchod extends RecyclerView.Adapter<ListAdapterObchod.ViewHolder> {
    private List<Obchody> podnikyList;
    private List<Obchody> podnikyArrayList = new ArrayList<>();
    ...
    public List<Obchody> getPodnikyList() {
        return podnikyList;
    }

    public ListAdapterObchod(List<Obchody> podnikyList) {
...
//    }
    ...
    @Override
    public ListAdapterObchod.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        View.OnClickListener listener = new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("obchod", (Serializable) podnikyList.get(holder.getAdapterPosition()));
    ...
    public void addAll(List<Obchody> podnikyList){
